...
// Since adding USB audio gadget support, this code also passes I & Q data over USB
// Code originally generated by copilot AI as a demo only ... good luck!  Mike/KB2ML
...
static double hpsdr_iq_gain = 1.0;  // in case we need to add gain to I and Q data going out
